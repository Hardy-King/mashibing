...
public class TestGenerator2 {
    public static void main(String[] args) {
        ...
        globalConfig.setAuthor("king")//设置作者
                .setOutputDir("/Users/goodking/IdeaProjects/mashibing/mybatis_plus_generator/src/main/java")//设置输出路径
        ...
        dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver").setUrl("jdbc:mysql://localhost:3306/mp?serverTimezone=UTC")
                .setUsername("root").setPassword("0804");
